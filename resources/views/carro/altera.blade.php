...
@section('conteudo')
	...
	<div class="card">
		<div class="content centralizar">
			<h1>Atualiza <strong class="text-primary">Carro</strong></h1>

			<form class="form-horizontal" action="{{action('CarroController@atualiza', $carro->id)}}"
				  method="post">
				...
				<div class="form-group ">
					...
					<div class="col-sm-8">
						<input type="number" min="1950" max="2018" name="ano" class="form-control" value="{{ $carro->ano}}">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<textarea name="descicao" rows="4" class="col-sm-8">{{$carro->descicao}}</textarea>
				</div>
